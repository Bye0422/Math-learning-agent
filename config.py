...
APP_PAGE_TITLE = "模块化 RAG Agent"
APP_TITLE = "模块化多格式 RAG Agent"
...
EXPORT_TITLE = "多格式 RAG Agent 问答导出"
...
# E盘项目内虚拟环境的 MinerU 命令
MINERU_CMD = r"E:\rag_agent_project\.venv\Scripts\mineru.exe"
...
# MinerU 输入输出临时目录，必须用英文路径
MINERU_TEMP_DIR_NAME = r"E:\mineru_runtime"

# 大 PDF 自动分批解析
MINERU_ENABLE_PAGE_BATCH = True

# 数学公式 PDF 建议 5 页一批，更稳
MINERU_PAGE_BATCH_SIZE = 5

# 你的 PDF 主要不是扫描版，所以先不自动转 OCR
MINERU_TRY_OCR_WHEN_AUTO_FAILS = False

# =========================
# MinerU 缓存配置
# =========================

MINERU_ENABLE_CACHE = True

MINERU_CACHE_DIR_NAME = r"E:\rag_agent_project\cache\mineru_markdown"
...
MEMORY_DB_PATH = r"E:\rag_agent_project\data\memory.db"
...
PRODUCT_NAME = "MathCard Agent"

PRODUCT_CHINESE_NAME = "数学错题卡 Agent"

APP_PAGE_TITLE = "数学错题卡生成 RAG Agent"

APP_TITLE = "MathCard Agent：数学错题卡生成 RAG Agent"
...
ENABLE_WRONGBOOK = True

WRONGBOOK_DB_PATH = r"E:\rag_agent_project\data\wrongbook.db"

CARD_OUTPUT_DIR = r"E:\rag_agent_project\data\cards"

WRONGBOOK_PDF_OUTPUT_DIR = r"E:\rag_agent_project\data\wrongbook_exports"
...
CARD_HTML_OUTPUT_DIR = r"E:\rag_agent_project\data\card_html"
...
MATHJAX_CDN_URL = "https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-chtml.js"